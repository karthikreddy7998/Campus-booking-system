...
function AdminRooms() {
  ...
  const handleSubmit = async (e) => {
    ...
    const url = editingRoom 
      ? `https://campus-booking-system-1-nqej.onrender.com/api/rooms/${editingRoom._id}`
      : "https://campus-booking-system-1-nqej.onrender.com/api/rooms/add";
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`https://campus-booking-system-1-nqej.onrender.com/api/rooms/${id}`, { method: "DELETE" });
      if (res.ok) {
